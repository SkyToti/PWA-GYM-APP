    ...
    <div className="flex gap-2 mb-8 overflow-x-auto pb-2 scrollbar-hide snap-x">
      {Object.values(routine).map((day) => (
        <button
          ...
          className={`whitespace-nowrap px-5 py-2.5 rounded-full font-bold text-sm transition-all duration-300 snap-start min-h-[44px] min-w-[44px] touch-manipulation cursor-pointer ${
            activeDay === day.id
